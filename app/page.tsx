      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex items-center justify-between mb-10 relative z-10">
            <a href="/articles" className="block group cursor-pointer">
            ...
            {Object.entries(categoryLabels).map(([key, { name, description }]) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative p-6 rounded-2xl border bg-card/50 backdrop-blur-sm hover:shadow-lg hover:border-primary/20 transition-all duration-300 h-full flex flex-col">
                    {/* 图标 */}
                    <div className={`w-12 h-12 rounded-xl ${config.iconBg} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-10 relative z-10">
            <a href="/career" className="block group cursor-pointer">
              <h2 className="text-3xl font-bold mb-2 group-hover:text-blue-600 transition-colors">职业发展</h2>
              <p className="text-muted-foreground">系统整合职场发展内容，助力你的职业成长</p>
            </a>
            <Link
              href="/career"
              className="inline-flex items-center justify-center gap-2 h-10 px-5 py-2 text-sm font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors shadow-sm"
            >
              查看全部
              <ArrowRight className="h-4 w-4" />
            </Link>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {resourceCategories.map((cat) => (
              ...
              >
                ...
                <div className="relative p-6 rounded-2xl border bg-card/50 backdrop-blur-sm hover:shadow-lg hover:border-blue-200 transition-all duration-300 h-full flex flex-col">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex items-center justify-between mb-10 relative z-10">
            <a href="/training" className="block group cursor-pointer">
              <h2 className="text-3xl font-bold mb-2 group-hover:text-primary transition-colors">题库训练</h2>
              <p className="text-muted-foreground">用结构化题库与 AI 评分报告提升产品拆解能力</p>
            </a>
            <Link
              href="/training"
              className="inline-flex items-center justify-center gap-2 h-10 px-5 py-2 text-sm font-medium rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Link href="/training/product-thinking" className="group relative overflow-hidden">
              ...
              <div className="relative p-6 rounded-2xl border bg-card/50 backdrop-blur-sm hover:shadow-lg hover:border-primary/20 transition-all duration-300 h-full flex flex-col">
                ...
                <h3 className="font-bold text-lg mb-2 group-hover:text-primary transition-colors">产品思维训练</h3>
                <p className="text-sm text-muted-foreground flex-1">
                  多行业、多类型产品案例拆解题库，支持草稿与 AI 评分报告。
                </p>
            ...
            <Link href="/training/programming" className="group relative overflow-hidden">
              ...
              <div className="relative p-6 rounded-2xl border bg-card/50 backdrop-blur-sm hover:shadow-lg hover:border-emerald-200 transition-all duration-300 h-full flex flex-col">
                ...
                <h3 className="font-bold text-lg mb-2 group-hover:text-emerald-600 transition-colors">编程知识训练</h3>
                <p className="text-sm text-muted-foreground flex-1">
                  前端、后端、数据库三大领域选择题库，即时反馈与解析，巩固技术基础。
                </p>
                <div className="mt-4 flex items-center gap-1 text-xs text-muted-foreground group-hover:text-emerald-600 transition-colors">
                  <span>开始训练</span>
                  <ArrowRight className="h-3 w-3 group-hover:translate-x-1 transition-transform" />
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-10 relative z-10">
            <a href="/tools" className="block group cursor-pointer">
              <h2 className="text-3xl font-bold mb-2 group-hover:text-primary transition-colors">实用工具</h2>
              <p className="text-muted-foreground">把常见产品工作流沉淀成可直接使用的工具</p>
            </a>
            <Link
              href="/tools"
              className="inline-flex items-center justify-center gap-2 h-10 px-5 py-2 text-sm font-medium rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Link href="/tools/prd" className="group relative overflow-hidden">
              ...
              <div className="relative p-6 rounded-2xl border bg-card/50 backdrop-blur-sm hover:shadow-lg hover:border-sky-200 transition-all duration-300 h-full flex flex-col">
                <div className="w-12 h-12 rounded-xl bg-sky-500/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <FileText className="h-6 w-6 text-sky-600" />
                </div>
                <h3 className="font-bold text-lg mb-2 group-hover:text-sky-600 transition-colors">PRD 生成</h3>
                <p className="text-sm text-muted-foreground flex-1">
                  输入需求背景、目标用户和功能点，生成 Markdown 格式的产品需求文档。
                </p>
                <div className="mt-4 flex items-center gap-1 text-xs text-muted-foreground group-hover:text-sky-600 transition-colors">
                  <span>打开工具</span>
                  <ArrowRight className="h-3 w-3 group-hover:translate-x-1 transition-transform" />
                </div>
              </div>
