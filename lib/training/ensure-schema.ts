...
export function ensureTrainingSchema(): void {
  ...
  const existingCount = sqlite.prepare(`SELECT COUNT(*) as c FROM training_questions`).get() as { c: number };
  if ((existingCount?.c || 0) === 0) {
    const stmt = sqlite.prepare(`
      INSERT OR IGNORE INTO training_questions
      (question_key, title, logo_url, prompt, industry, product_type, difficulty, reference_points, is_active)
      VALUES
      (@question_key, @title, @logo_url, @prompt, @industry, @product_type, @difficulty, @reference_points, 1)
    `);
    ...
    const seeds = [
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=douyin.com&sz=128',
        industry: 'internet',
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=cmbchina.com&sz=128',
        industry: 'finance',
        product_type: 'mobile_app',
        difficulty: 'advanced',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=yuanfudao.com&sz=128',
        industry: 'education',
        product_type: 'web',
        difficulty: 'intermediate',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=wechat.com&sz=128',
        industry: 'internet',
        product_type: 'mobile_app',
        difficulty: 'advanced',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=meituan.com&sz=128',
        industry: 'retail',
        product_type: 'mobile_app',
        difficulty: 'advanced',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=temu.com&sz=128',
        industry: 'retail',
        product_type: 'mobile_app',
        difficulty: 'advanced',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=airbnb.com&sz=128',
        industry: 'internet',
        product_type: 'web',
        difficulty: 'advanced',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=pingan.com&sz=128',
        industry: 'healthcare',
        product_type: 'mobile_app',
        difficulty: 'advanced',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=mi.com&sz=128',
        industry: 'internet',
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=zoom.us&sz=128',
        industry: 'internet',
        product_type: 'saas',
        difficulty: 'intermediate',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=alipay.com&sz=128',
        industry: 'finance',
        product_type: 'mobile_app',
        difficulty: 'advanced',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=jd.com&sz=128',
        industry: 'retail',
        product_type: 'saas',
        difficulty: 'advanced',
        prompt:
      ...
      },
      {
        ...
        logo_url: 'https://www.google.com/s2/favicons?domain=duolingo.com&sz=128',
        industry: 'education',
        product_type: 'mobile_app',
        difficulty: 'beginner',
        prompt:
    ...
    const tx = sqlite.transaction(() => {
      for (const row of seeds) stmt.run(row);
    });
    tx();
  }
  ...
  const pkExisting = sqlite.prepare(`SELECT COUNT(*) as c FROM programming_questions`).get() as { c: number };
  if ((pkExisting?.c || 0) === 0) {
    const filePath = path.join(process.cwd(), 'data', 'programming-questions.json');
    ...
    const stmt = sqlite.prepare(`
      INSERT OR IGNORE INTO programming_questions
      (question_key, domain, stem, option_a, option_b, option_c, option_d, correct_option, explanation, links)
      VALUES
      (@questionKey, @domain, @stem, @optionA, @optionB, @optionC, @optionD, @correctOption, @explanation, @links)
    `);
